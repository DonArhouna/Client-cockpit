            ...
            <CardContent className="p-6">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <FilterSelect label="Entrepôt" value="Tous les entrepôts" />
                        <FilterSelect label="Famille d'article" value="Toutes les familles" />
                        <FilterSelect label="État du stock" value="Tous les états" />
                    </div>
                </div>
            </CardContent>
        </Card>
